...
public class AdminControllerAdvice {
    ...
    public Result<Object> handleException(Exception ex, HttpServletRequest request) {
        AdminException adminException = new AdminException(PublicExceptionCodeEnum.EX_UNKNOWN.getCode(), ex);
        ExceptionLog.errorPrintStraceAndPath(log, RequestUtil.getErrorMsg(request), adminException);
        log.error(EXCEPTION_MSG_KEY, ex.getMessage());
    ...
    public Result<Object> handleException(NullPointerException ex, HttpServletRequest request) {
        AdminException adminException = new AdminException(PublicExceptionCodeEnum.EX_OPERATION_FAIL.getCode(), ex);
        ExceptionLog.errorAndPath(log, RequestUtil.getErrorMsg(request), adminException);
        // 把异常打到日志
        log.error(EXCEPTION_MSG_KEY, ExceptionUtils.getStackTrace(ex));
    ...
    public Result handleException(MaxUploadSizeExceededException ex, HttpServletRequest request) {
        AdminException adminException = new AdminException(PublicExceptionCodeEnum.Ex_FILE_SIZE_MAX_ERROR.getCode(), ex);
        ExceptionLog.errorAndPath(log, RequestUtil.getErrorMsg(request), adminException);
    ...
    public Result methodArgumentTypeMismatchException(MethodArgumentTypeMismatchException ex, HttpServletRequest request) {
        ...
        AdminException adminException = new AdminException(exParamTypeError.getCode(), ex);
        ExceptionLog.errorAndPath(log, RequestUtil.getErrorMsg(request), adminException);
    ...
    public Result missingPathVariableException(MissingPathVariableException ex, HttpServletRequest request){
        ...
        AdminException adminException = new AdminException(paramError.getCode(), ex);
        ExceptionLog.errorAndPath(log, RequestUtil.getErrorMsg(request), adminException);
    ...
    public Result<Object> handleException(HttpRequestMethodNotSupportedException ex, HttpServletRequest request) {
        AdminException adminException = new AdminException(PublicExceptionCodeEnum.EX_METHOD_ERROR.getCode(), ex);
        ExceptionLog.errorAndPath(log, RequestUtil.getErrorMsg(request), adminException);
        ...
        binder.registerCustomEditor(Date.class, new CustomDateEditor(dateFormat, true) {
            ...
            public void setAsText(String text) {
                try {
                    ...
                    ExceptionLog.error(log, new AdminException(PublicExceptionCodeEnum.Ex_PARAM_ERROR.getCode(), ex));
                }
            }
        });
    }
